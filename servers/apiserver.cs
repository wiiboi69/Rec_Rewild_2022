            ...
            try
            {
                this.listener.Prefixes.Add("https://localhost:44302/");
                {
                    for (; ; )
                    {
                        ...
                        Console.WriteLine("API request Method: " + request.HttpMethod);
                        ...
                        if (rawUrl.Contains("customAvatarItems/v1/me"))
                        {
                        ...
                        */
                        ...
                        if (rawUrl == "/playersettings")
                        {
                            if (request.HttpMethod == "PUT")
                            {
                                ...
                                string key = "";
                                string value = "";
                                //key=PlayerSessionCount&value=1
                                string[] strings = [];
                                strings = text.Split('&', StringSplitOptions.RemoveEmptyEntries);
                                ...
                                key = strings[0].Substring("key=".Length);
                                value = strings[1].Substring("value=".Length);
                                Console.WriteLine($"key: {key} value: {value}");

                                Settings.SetPlayerSettings(key, value);
