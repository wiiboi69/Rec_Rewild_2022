...
namespace api
{
    internal class room_util
    {
        public static string find_room_with_id(string rawUrl, int value)
        {
            ...
            if (temp2 != "")
            {
                ...
                try
                {
                    ...
                    return new WebClient().DownloadString("https://raw.githubusercontent.com/nito9999/Rec_rewild_server_data_2022/main/rooms_name/" + temp2 + ".txt").ToString();
                }
                catch (Exception e)
                {
        ...
        roomdownload_ToLower:
            if (temp2 != "")
            {
                ...
                try
                {
                    ...
                    string replaceWith = "";
                    temp2 = temp2.Replace("\r\n", replaceWith).Replace("\n", replaceWith).Replace("\r", replaceWith);
                    return new WebClient().DownloadString("https://raw.githubusercontent.com/nito9999/Rec_rewild_server_data_2022/main/rooms_name/" + temp2.ToLower() + ".txt").ToString();
                }
                catch (Exception e)
                {
                    Console.WriteLine(e.Message);
            ...
            else
            {
                try
                {
                    ...
                    temp2 = new WebClient().DownloadString("https://raw.githubusercontent.com/nito9999/Rec_rewild_server_data_2022/main/rooms_id/" + temp1 + ".txt").ToString();
                    goto roomdownload;
            ...
            return new WebClient().DownloadString("https://raw.githubusercontent.com/nito9999/Rec_rewild_server_data_2022/main/rooms_name/dormroom.txt").ToString();
        }
        ...
        public static string room_change_fix_room_2022(string value)
        {
            string temp1;
            //roomdata.RoomRootv2 root = JsonConvert.DeserializeObject(value);
            RoomRootv2 root = JsonConvert.DeserializeObject<RoomRootv2>(value);
            ...
            temp1 = JsonConvert.SerializeObject(root);
            root = JsonConvert.DeserializeObject<RoomRootv2>(temp1);
            List<SubRoomsv2_2022> subroomsv2data = new List<SubRoomsv2_2022>
            {

            };

            SubRoomsv2_2022 subroomdata = new SubRoomsv2_2022
            {
                Accessibility = 0,
                DataBlob = "",
                IsSandbox = true,
            ...
            do
            {
                ...
                subroomdata.CreatedAt = DateTime.Parse(root.CreatedAt);

                subroomdata.SubRoomDataSaveId = subroomdata.SubRoomId;
            ...
            RoomRootv4 rootv2 = new RoomRootv4
            {
                Accessibility = root.Accessibility,
                //"Accessibility": 2,
        ...
        public static string find_room_with_id_lowercase(string rawUrl, int value)
        {
            ...
            if (temp2 != "")
            {
                ...
                {
                    Console.WriteLine("found room name: " + temp2 + " using room id: " + temp1);
                    return new WebClient().DownloadString("https://raw.githubusercontent.com/nito9999/Rec_rewild_server_data_2022/main/rooms_name/" + temp2.ToLower() + ".txt").ToString().ToLower();
                }
                catch
                {
                    goto roomfaileddownload;
        ...
        roomfaileddownload:
            Console.WriteLine("can't find room id : " + temp1);
            return new WebClient().DownloadString("https://raw.githubusercontent.com/nito9999/Rec_rewild_server_data_2022/main/rooms_name/dormroom.txt").ToString().ToLower();
        }
        ...
        internal static string room_fix_Rooms_list_2022(string s)
        {
            Roomlist roomlistdata = JsonConvert.DeserializeObject<Roomlist>(s);
            roomlistv2_2 roomlistdatav2 = new roomlistv2_2
            {
                Results = [],
                TotalResults = roomlistdata.TotalResults,
            };
